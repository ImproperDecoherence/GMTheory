...
GTEST(GScaleTest) {
    ...
    const GHarmony scaleCmajorExpected{NoteNames{"C", "D", "E", "F", "G", "A", "B"} | noteNameToNoteValue};
    GCHECK("Note values C nataural major", scaleCmajor.noteValues(), scaleCmajorExpected);

    const GHarmony scaleCmajorExtendedExpected{NoteNames{"C1", "D1", "E1", "F1", "G1", "A1", "B1", "C2"} |
                                               noteNameToNoteValue};
    ...
    const GHarmony scaleDorianExpected{NoteNames{"D0", "E0", "F0", "G0", "A0", "B0", "C1"} |
                                       noteNameToNoteValue};
    ...
    const GHarmony scalePhrygianExpected{NoteNames{"E0", "F0", "G0", "A0", "B0", "C1", "D1"} |
                                         noteNameToNoteValue};
    ...
    const GHarmony scaleLydianExpected{NoteNames{"F0", "G0", "A0", "B0", "C1", "D1", "E1"} |
                                       noteNameToNoteValue};
    ...
    const GHarmony scaleMixolydianExpected{NoteNames{"G0", "A0", "B0", "C1", "D1", "E1", "F1"} |
                                           noteNameToNoteValue};
    ...
    const GHarmony scaleAminorExpected{NoteNames{"A0", "B0", "C1", "D1", "E1", "F1", "G1"} |
                                       noteNameToNoteValue};
    GCHECK("Note values A natural minor", scaleAminor.noteValues(), scaleAminorExpected);

    const GHarmony scaleAminorExtendedExpected{NoteNames{"A0", "B0", "C1", "D1", "E1", "F1", "G1", "A1"} |
                                               noteNameToNoteValue};
    ...
    const GHarmony scaleLocrianExpected{NoteNames{"B0", "C1", "D1", "E1", "F1", "G1", "A1"} |
                                        noteNameToNoteValue};
